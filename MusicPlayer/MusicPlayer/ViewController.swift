...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func initializePlayer() {
        ...
        do {
            ...
            self.player.delegate = self // 이 뷰 컨트롤러의 인스턴스가 AVAudioPlayer의 델리게이트로 역할을 수행하겠다
...
//        self.addViewsWithCode() // initialize하기 전에 view를 코드를 통해 얹어주자
